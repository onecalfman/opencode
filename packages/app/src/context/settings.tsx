  ...
  init: () => {
    ...
    return {
      ...
      general: {
        ...
        tabLayout: withFallback(() => store.general?.tabLayout, defaultSettings.general.tabLayout),
        setTabLayout(value: "horizontal" | "vertical") {
          setStore("general", "tabLayout", value)
        },
        newLayoutDesigns,
